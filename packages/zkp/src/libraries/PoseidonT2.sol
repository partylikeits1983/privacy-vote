...
library PoseidonT2 {
    uint256 constant M00 = 0x066f6f85d6f68a85ec10345351a23a3aaf07f38af8c952a7bceca70bd2af7ad5;
    uint256 constant M01 = 0x0cc57cdbb08507d62bf67a4493cc262fb6c09d557013fff1f573f431221f8ff9;
    uint256 constant M10 = 0x2b9d4b4110c9ae997782e1509b1d0fdb20a7c02bbd8bea7305462b9f8125b1e8;
    uint256 constant M11 = 0x1274e649a32ed355a31a6ed69724e1adade857e86eb5c3a121bcd147943203c8;

    // See here for a simplified implementation: https://github.com/vimwitch/poseidon-solidity/blob/e57becdabb65d99fdc586fe1e1e09e7108202d53/contracts/Poseidon.sol#L40
    // Inspired by: https://github.com/iden3/circomlibjs/blob/v0.0.8/src/poseidon_slow.js
    function hash(uint256[1] memory) public pure returns (uint256) {
        assembly {
            ...
            scratch0 :=
                add(
                    ...
                    add(
                        2135211596334038589877319861485022046541061518379136709265746501298180122869, mulmod(state1, M10, F)
                    )
                )
            let scratch1 :=
                add(
